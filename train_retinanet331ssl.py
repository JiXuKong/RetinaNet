...
from retinanet331ssl import Retinanet
...
#ssl data
ssl_data = pascal_voc(phase='ssl_train', flipped=True, img_path = cfg.ssl_img_path,\
                  label_path=cfg.ssl_label_path, img_txt=cfg.ssl_img_txt, is_training=True)
#ssl data
...
with tf.variable_scope('learning_rate'):
    learning_rate = cosine_decay_with_warmup(
        ...
        learning_rate_base = 0.043333/32,
...
if __name__ == '__main__':
    ...
    for epoch in range(1, max_epoch + 1):
        ...
        for step in range(1, epoch_step + 1):
            ...
            ssl_images, ssl_labels, ssl_imnm, ssl_num_boxes = data.get()
            
            load_timer.toc()
            feed_dict = {net.ori_image: images,
                         net.ori_label: labels,
                         net.ori_num_boxes:num_boxes,
                         net.ssl_image: images,
                         net.ssl_label: labels,
                         net.ssl_num_boxes:num_boxes
                        }
